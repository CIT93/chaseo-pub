...
const handleButtonClick = function() {
    ...
    let message = `Hello, ${totalCost}! You have clicked the button ${totalCost} time(s).`;
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    totalDisplayElement.textContent = `Welcome, ${totalCost}! Click the button below to start counting`    
})